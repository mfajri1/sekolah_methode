...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Selamat Datang <?= $_SESSION['login']['user_fullname']?> Pada Sistem Penentuan Siswa Kelas Unggul Di SMP N 25 Padang</h1>
</div>
...
<div class="row">
    ...
    $hitungG = $ambil->num_rows;

    // kelas 
    $ambil2 = $koneksi->query("SELECT * FROM ms_kelas");
    $hitungD = $ambil2->num_rows;
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col">
                                <div class="progress progress-sm mr-2">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: 80%" aria-valuenow="8" aria-valuemin="0" aria-valuemax="10"></div>
                                </div>
                            </div>
                        </div>
                    </div>
